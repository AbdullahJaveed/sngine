          ...
          <ul class="side-nav">
            ...
            <li {if $view == "dashboard"}class="active" {/if}>
              <a href="{$system['system_url']}/{$control_panel['url']}">
                <i class="fa fa-tachometer-alt fa-lg fa-fw mr10" style="color: #878E94"></i>{__("Dashboard")}
              </a>
            </li>
            <!-- Dashboard -->
            ...
            {if $user->_is_admin}
              ...
              <li {if $view == "settings"}class="active" {/if}>
                <a href="#settings" data-bs-toggle="collapse" {if $view == "settings"}aria-expanded="true" {/if}>
                  <i class="fa fa-cog fa-lg fa-fw mr10" style="color: #878E94"></i>{__("Settings")}
                </a>
              ...
              <li {if $view == "themes"}class="active" {/if}>
                <a href="{$system['system_url']}/{$control_panel['url']}/themes">
                  <i class="fa fa-desktop fa-lg fa-fw mr10" style="color: #878E94"></i>{__("Themes")}
                </a>
              </li>
              <!-- Themes -->
              ...
              <li {if $view == "design"}class="active" {/if}>
                <a href="{$system['system_url']}/{$control_panel['url']}/design">
                  <i class="fa fa-paint-brush fa-lg fa-fw mr10" style="color: #878E94"></i>{__("Design")}
                </a>
              </li>
              <!-- Design -->
              ...
              <li {if $view == "languages"}class="active" {/if}>
                <a href="{$system['system_url']}/{$control_panel['url']}/languages">
                  <i class="fa fa-language fa-lg fa-fw mr10" style="color: #878E94"></i>{__("Languages")}
                </a>
              </li>
              <!-- Languages -->
              ...
              <li {if $view == "countries"}class="active" {/if}>
                <a href="{$system['system_url']}/{$control_panel['url']}/countries">
                  <i class="fa fa-globe fa-lg fa-fw mr10" style="color: #878E94"></i>{__("Countries")}
                </a>
              </li>
              <!-- Countries -->
              ...
              <li {if $view == "currencies"}class="active" {/if}>
                <a href="{$system['system_url']}/{$control_panel['url']}/currencies">
                  <i class="fa fa-money-bill-alt fa-lg fa-fw mr10" style="color: #878E94"></i>{__("Currencies")}
                </a>
              </li>
              <!-- Currencies -->
              ...
              <li {if $view == "genders"}class="active" {/if}>
                <a href="{$system['system_url']}/{$control_panel['url']}/genders">
                  <i class="fa fa-venus-mars fa-lg fa-fw mr10" style="color: #878E94"></i>{__("Genders")}
                </a>
              </li>
              <!-- Genders -->
            {/if}
            ...
            <ul class="side-nav">
              ...
              <li {if $view == "pwa"}class="active" {/if}>
                <a href="{$system['system_url']}/{$control_panel['url']}/pwa">
                  <i class="fa-regular fa-window-restore fa-lg fa-fw mr10" style="color: #878E94"></i>{__("PWA")}
                </a>
              </li>
              <!-- PWA -->
              ...
              <li {if $view == "apis"}class="active" {/if}>
                <a href="{$system['system_url']}/{$control_panel['url']}/apis">
                  <i class="fa-solid fa-shapes fa-lg fa-fw mr10" style="color: #878E94"></i>{__("APIs Settings")}
                </a>
              </li>
              <!-- APIs Settings -->
              ...
              <li {if $view == "apps"}class="active" {/if}>
                <a href="{$system['system_url']}/{$control_panel['url']}/apps">
                  <i class="fa-solid fa-mobile fa-lg fa-fw mr10" style="color: #878E94"></i>{__("Native Apps")}
                </a>
              </li>
              <!-- Native Apps -->
