<?php
/* Smarty version 5.5.2, created on 2025-10-15 08:18:53
  from 'file:admin.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.2',
  'unifunc' => 'content_68ef58edcb4703_74713329',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'cb00866669248d5507363f6a48c955e655ae81a5' => 
    array (
      0 => 'admin.tpl',
      1 => 1760509192,
      2 => 'file',
...
function content_68ef58edcb4703_74713329 (\Smarty\Template $_smarty_tpl) {
...
">
                <i class="fa fa-tachometer-alt fa-lg fa-fw mr10" style="color: #878E94"></i><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Dashboard");?>
            ...
            <?php if ($_smarty_tpl->getValue('user')->_is_admin) {?>
              ...
              <li <?php if ($_smarty_tpl->getValue('view') == "settings") {?>class="active" <?php }?>>
                <a href="#settings" data-bs-toggle="collapse" <?php if ($_smarty_tpl->getValue('view') == "settings") {?>aria-expanded="true" <?php }?>>
                  <i class="fa fa-cog fa-lg fa-fw mr10" style="color: #878E94"></i><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Settings");?>
...
/<?php echo $_smarty_tpl->getValue('control_panel')['url'];?>
/themes">
                  <i class="fa fa-desktop fa-lg fa-fw mr10" style="color: #878E94"></i><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Themes");?>
...
/<?php echo $_smarty_tpl->getValue('control_panel')['url'];?>
/design">
                  <i class="fa fa-paint-brush fa-lg fa-fw mr10" style="color: #878E94"></i><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Design");?>
...
/<?php echo $_smarty_tpl->getValue('control_panel')['url'];?>
/languages">
                  <i class="fa fa-language fa-lg fa-fw mr10" style="color: #878E94"></i><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Languages");?>
...
/<?php echo $_smarty_tpl->getValue('control_panel')['url'];?>
/countries">
                  <i class="fa fa-globe fa-lg fa-fw mr10" style="color: #878E94"></i><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Countries");?>
...
/<?php echo $_smarty_tpl->getValue('control_panel')['url'];?>
/currencies">
                  <i class="fa fa-money-bill-alt fa-lg fa-fw mr10" style="color: #878E94"></i><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Currencies");?>
...
/<?php echo $_smarty_tpl->getValue('control_panel')['url'];?>
/genders">
                  <i class="fa fa-venus-mars fa-lg fa-fw mr10" style="color: #878E94"></i><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Genders");?>
...
/<?php echo $_smarty_tpl->getValue('control_panel')['url'];?>
/pwa">
                  <i class="fa-regular fa-window-restore fa-lg fa-fw mr10" style="color: #878E94"></i><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("PWA");?>
...
/<?php echo $_smarty_tpl->getValue('control_panel')['url'];?>
/apis">
                  <i class="fa-solid fa-shapes fa-lg fa-fw mr10" style="color: #878E94"></i><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("APIs Settings");?>
...
/<?php echo $_smarty_tpl->getValue('control_panel')['url'];?>
/apps">
                  <i class="fa-solid fa-mobile fa-lg fa-fw mr10" style="color: #878E94"></i><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Native Apps");?>
