<?php
/* Smarty version 5.5.2, created on 2025-10-15 08:26:22
  from 'file:_header.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.2',
  'unifunc' => 'content_68ef5aaeb13e11_26191297',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1b14719eeca2e41c4544c81f85a8b34716f96109' => 
    array (
      0 => '_header.tpl',
      1 => 1760516780,
      2 => 'file',
...
function content_68ef5aaeb13e11_26191297 (\Smarty\Template $_smarty_tpl) {
...
" <?php if ($_smarty_tpl->getValue('system')['theme_mode_night']) {?>data-bs-theme="dark" <?php }?> class="<?php if ($_smarty_tpl->getValue('system')['theme_mode_night']) {?>night-mode<?php }?> visitor n_chat <?php if ($_smarty_tpl->getValue('page') == 'index' && !$_smarty_tpl->getValue('system')['newsfeed_public']) {?>index-body<?php }?> <?php if ($_smarty_tpl->getValue('system')['theme'] == 'custom-dark') {?>theme-custom-dark<?php }?>" <?php if ($_smarty_tpl->getValue('page') == 'profile' && $_smarty_tpl->getValue('system')['system_profile_background_enabled'] && $_smarty_tpl->getValue('profile')['user_profile_background']) {?>style="background: url(<?php echo $_smarty_tpl->getValue('profile')['user_profile_background'];?>
) fixed !important; background-size: 100% auto;" <?php }?>>
    <!-- Inject deferred theme stylesheet + noscript fallback -->
    <link rel="preload" href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/content/themes/<?php echo $_smarty_tpl->getValue('system')['theme'];?>
/css/theme.min.css" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/content/themes/<?php echo $_smarty_tpl->getValue('system')['theme'];?>
/css/theme.min.css"></noscript>
...
if (!$_smarty_tpl->getValue('system')['system_live']) {?> n_live<?php }?> <?php if ($_smarty_tpl->getValue('system')['theme'] == 'custom-dark') {?>theme-custom-dark<?php }?>" <?php if ($_smarty_tpl->getValue('page') == 'profile' && $_smarty_tpl->getValue('system')['system_profile_background_enabled'] && $_smarty_tpl->getValue('profile')['user_profile_background']) {?>style="background: url(<?php echo $_smarty_tpl->getValue('profile')['user_profile_background'];?>
...
/content/themes/<?php echo $_smarty_tpl->getValue('system')['theme'];?>
/images/blank_profile_male.png" loading="lazy" decoding="async">
