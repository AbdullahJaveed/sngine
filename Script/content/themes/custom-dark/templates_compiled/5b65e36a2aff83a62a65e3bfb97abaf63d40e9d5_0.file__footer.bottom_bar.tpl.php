<?php
/* Smarty version 5.5.2, created on 2025-10-14 07:26:16
  from 'file:_footer.bottom_bar.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if (
  $_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array(
    'version' => '5.5.2',
    'unifunc' => 'content_68edfb187da790_02561693',
    'has_nocache_code' => false,
    'file_dependency' =>
      array(
        '5b65e36a2aff83a62a65e3bfb97abaf63d40e9d5' =>
          array(
  ...
  function content_68edfb187da790_02561693(\Smarty\Template $_smarty_tpl)
  {
    ...
    <div class="footer-bottom-bar<?php if ($_smarty_tpl->getValue('page') == 'reels') { ?>x-hidden<?php } ?>">
      <div class="container">
        <div class="footer-bottom-bar-links">
          <!-- home -->
          <div
            class="link <?php if ($_smarty_tpl->getValue('page') == 'index' && $_smarty_tpl->getValue('view') == '') { ?>active<?php } ?>">
...
/reels">
          ...
          <?php } elseif ($_smarty_tpl->getValue('system')['watch_enabled']) { ?>
            <div
              class="link <?php if ($_smarty_tpl->getValue('page') == 'index' && $_smarty_tpl->getValue('view') == 'watch') { ?>active<?php } ?>">
              <a href="<?php echo $_smarty_tpl->getValue('system')['system_url']; ?>
/watch">
                <?php ob_start();
